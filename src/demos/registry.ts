...
const authored: CatalogEntry[] = [
  {
    ...
    subjectClass: 'object',
    blurb:
      'An Ocean guitar with an exclusive Hyper3D reference, with the original '
    ...
    referenceLabel: 'Hyper3D Reference',
    sourcePath: 'src/demos/prs-ocean/createPrsOceanModel.ts',
    sourceUrl: `${REPO}/src/demos/prs-ocean/createPrsOceanModel.ts`,
    generatedWith: 'img2threejs v1.5.2 · Hyper3D reference · GLB force-measured · embedded TypeScript surface',
    prompt:
