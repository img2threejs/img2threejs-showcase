 ...
 *
 * The clips shipped here: preset:climb 3.50s, preset:dive 2.75s, preset:hurt 13.88s, preset:jump 2.25s, preset:turn 3.88s, preset:walk 2.38s, preset:biped:jump_down 3.75s, preset:biped:run 1.29s, preset:biped:sit 5.77s, preset:biped:afraid 2.10s, preset:biped:agree 3.23s, preset:biped:angry_01 2.83s, preset:biped:angry_02 1.77s, preset:biped:angry_03 2.90s, preset:biped:depressed 3.70s, preset:biped:freaky 0.67s, preset:biped:frustrated_01 2.87s, preset:biped:greet_01 3.54s, preset:biped:greet_02 5.63s, preset:biped:greet_03 9.13s, preset:biped:greet_04 2.83s, preset:biped:heart_pose 5.42s, preset:biped:scared_02 3.33s, preset:biped:dance_01 23.21s, preset:biped:dance_02 12.83s, preset:biped:dance_03 12.83s.
...
export const MONSTER_CUTE_CLIPS = ['preset:climb', 'preset:dive', 'preset:hurt', 'preset:jump', 'preset:turn', 'preset:walk', 'preset:biped:jump_down', 'preset:biped:run', 'preset:biped:sit', 'preset:biped:afraid', 'preset:biped:agree', 'preset:biped:angry_01', 'preset:biped:angry_02', 'preset:biped:angry_03', 'preset:biped:depressed', 'preset:biped:freaky', 'preset:biped:frustrated_01', 'preset:biped:greet_01', 'preset:biped:greet_02', 'preset:biped:greet_03', 'preset:biped:greet_04', 'preset:biped:heart_pose', 'preset:biped:scared_02', 'preset:biped:dance_01', 'preset:biped:dance_02', 'preset:biped:dance_03'] as const;
