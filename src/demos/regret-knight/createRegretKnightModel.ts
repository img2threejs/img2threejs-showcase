...
export function createRegretKnightModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const attachment_chest_3 = {"parentSocket": "abdomen-chest", "localStart": [0.0, 0.18628, 0.0028], "localEnd": [0.0, 0.44352, 0.0056], "contactType": "rigid-weld", "baseRadius": 0.16513, "endRadius": 0.11299, "embedDepth": 0.03, "gapTolerance": 0.01, "evidenceRefs": ["full-object"]};
  ...
  const attachment_clavicle_l_17 = {"parentSocket": "chest-clavicle-l", "localStart": [0.03476, 0.24044, 0.0056], "localEnd": [0.21728, 0.23484, 0.0112], "contactType": "rigid-weld", "baseRadius": 0.0308, "endRadius": 0.0476, "embedDepth": 0.03, "gapTolerance": 0.01, "evidenceRefs": ["full-object"]};
  ...
  const mesh_clavicle_l_17Geometry = endpoint_clavicle_l_17
    ...
    : buildWatertightCapsule(0.35, 0.7, 16, 32, 1);
  if (!endpoint_clavicle_l_17) {
    mesh_clavicle_l_17Geometry.scale(0.18251520000000002, 0.09520000000000002, 0.09520000000000002);
  }
  ...
  const attachment_clavicle_r_36 = {"parentSocket": "chest-clavicle-r", "localStart": [-0.03476, 0.24044, 0.0056], "localEnd": [-0.21728, 0.23484, 0.0112], "contactType": "rigid-weld", "baseRadius": 0.0308, "endRadius": 0.0476, "embedDepth": 0.03, "gapTolerance": 0.01, "evidenceRefs": ["full-object"]};
  ...
  const mesh_clavicle_r_36Geometry = endpoint_clavicle_r_36
    ...
    : buildWatertightCapsule(0.35, 0.7, 16, 32, 1);
  if (!endpoint_clavicle_r_36) {
    mesh_clavicle_r_36Geometry.scale(0.18251520000000002, 0.09520000000000002, 0.09520000000000002);
  }
