...
| [Y’bneth — Treant Signature VFX](https://img2threejs.io/#/demo/monster-tree)<br><sub>Four authored tree-weight actions: breathing roots, a hand-bound heartwood lash, a two-hand Rootbreaker and a warm-seed canopy; all stops are scheduled and hitstopped.</sub> | character | ✅ | [Hoài Nhớ](https://github.com/hoainho) |
